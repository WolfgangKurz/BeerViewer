import { Observable, ObservableCallback, DisposableObservable } from "./Observable";
...
export class DisposableObservableDataWrapper<T> extends DisposableObservable implements IRawDataWrapper<T> {
	private _raw: T;
	public get raw(): T {
		return this.$._raw;
	}
