...
export class MapWorldInfo extends KanColleWrapperBase<kcsapi_mst_maparea> implements IIdentifiable {
...
export class MapAreaInfo extends KanColleWrapperBase<kcsapi_mst_mapinfo> implements IIdentifiable {
	public get Id(): number { return this.raw.api_id }
	public get Name(): string { return this.raw.api_name }
